...
import com.listomate.client.MyRequestFactory.MessageRequest;
import com.listomate.shared.MessageProxy;
...
public class ListomateWidget extends Composite {
  ...
  interface ListomateUiBinder extends UiBinder<Widget, ListomateWidget> {
  }

  private static ListomateUiBinder uiBinder = GWT.create(ListomateUiBinder.class);
